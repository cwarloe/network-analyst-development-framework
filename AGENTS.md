...
- **Markdown is the deliverable.** The maintainer reads it directly and does not want a rendered companion — no HTML build, no published web version. One source, no drift.
