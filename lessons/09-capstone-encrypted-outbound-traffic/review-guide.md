...
This pilot implements the existing [Network Analyst Capability Model v0.1](../../docs/capability-model.md) and [Assessment Evidence Model v0.1](../../docs/evidence-model.md). Its source cases remain available as the [encrypted-traffic validation slice](../../docs/archive/design-studio/2026-07-13-encrypted-outbound-traffic-capability-validation-slice.md) and [DNS model-revision validation slice](../../docs/archive/design-studio/2026-07-13-dns-failure-model-revision-capability-validation-slice.md).
