...
This slice tests whether the [proposed Network Analyst Capability Model v0.1](../../capability-model.md) can describe and expose evidence of useful analyst performance in one realistic case.
