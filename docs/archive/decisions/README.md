...
These ADRs are preserved as historical records. The [NADF Active Training Architecture Baseline](../../architecture.md) is the single active governing training architecture baseline.
...
| [ADR-0003](0003-use-lightweight-portfolio-concern-flow-view-interpretation.md) | Use a lightweight portfolio, concern, and flow view interpretation | accepted | 2026-07-12 |
