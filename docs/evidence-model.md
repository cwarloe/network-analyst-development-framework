...
| Capability target | [Network Analyst Capability Model v0.1](capability-model.md) |
| Validation inputs | [Encrypted outbound traffic](archive/design-studio/2026-07-13-encrypted-outbound-traffic-capability-validation-slice.md); [DNS failure and model revision](archive/design-studio/2026-07-13-dns-failure-model-revision-capability-validation-slice.md) |
| Governing identity | [ADR-0001](archive/decisions/0001-adopt-expertise-development-network-analyst-architecture.md) |
