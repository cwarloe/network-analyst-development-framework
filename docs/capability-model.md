...
| Primary decision | [ADR-0001](archive/decisions/0001-adopt-expertise-development-network-analyst-architecture.md) |
| Architecture posture | [ADR-0002](archive/decisions/0002-adopt-deliberate-multi-view-architecture-posture.md) |
| View interpretation | [ADR-0003](archive/decisions/0003-use-lightweight-portfolio-concern-flow-view-interpretation.md) |
...
| Governing proposal | [Architecture Baseline v0.2](archive/design-studio/2026-07-11-nadf-architecture-baseline-v0.2-proposed.md) |
...
- **RS/AJ:** Research supports the direction and design judgment defines its NADF-specific expression.
...
|---|---|---|
| 2026-07-13 | [Encrypted outbound traffic](archive/design-studio/2026-07-13-encrypted-outbound-traffic-capability-validation-slice.md) | The model described the work without structural revision. Learning/model revision and audience adaptation were not observable in the single initial-assessment sample; these are sampling limits rather than model defects. |
| 2026-07-13 | [DNS failure and model revision](archive/design-studio/2026-07-13-dns-failure-model-revision-capability-validation-slice.md) | Feedback, new evidence, an observed outcome, a transfer check, and two audience-specific products made LR-1 through LR-4 and CT-2 observable. No structural revision was required. |
