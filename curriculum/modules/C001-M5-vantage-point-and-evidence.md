# C001-M5 — Vantage Point and Evidence
...
- **Assumes:** M1 through M4. You can read a conversation, describe expected behavior, and state what encryption prevents you from seeing.
